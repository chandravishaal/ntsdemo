...
const CryptoConverter = () => {
  ...
  return (
    <div className="form-bg min-h-screen py-4 sm:py-8 md:py-12 border-b-[15px] sm:border-b-[20px] md:border-b-[25px] border-cyan-400">
      <div className="container max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
        {renderStep()}
      </div>
    </div>
