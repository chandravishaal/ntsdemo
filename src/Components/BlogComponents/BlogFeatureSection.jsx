...
const BlogFeatureSection = () => {
  useEffect(() => {
    // GSAP animation for blog items and text section with ScrollTrigger
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: ".blog-section",  // Trigger animation when this section comes into view
        start: "top center+=100",  // Animation starts when top of the section hits the center+100px
        toggleActions: "play none none reset",  // Animation plays on scroll
      }
    });
    
    tl.from(".blog-item", { y: 50, opacity: 0, stagger: 0.2, duration: 1.2 });
    tl.from(".text-section", { y: 50, opacity: 0, duration: 1 }, "<");

  }, []);

  return (
    <div className="w-full py-16 bg-white px-8 blog-section">
      <div className="container mx-auto flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-[50%] grid grid-cols-2 gap-[2%] lg:gap-[3%] mb-[-4%] mt-[15%] lg:mt-[14%] lg:mr-[-5%]">
          ...
          <div className="relative blog-item">
            <img 
              src={blogImage3}  
              className="w-full h-auto mb-[14%] ml-[2%] max-w-[89%] lg:max-w-[90%] lg:h-[82%] lg:w-[95%] lg:ml-[0.7%] rounded-lg" 
              alt="Blog Image 1"
            />
          </div>
