  ...
  return (
    <div className="w-full py-[4%] bg-white px-8 lg:px-8">
      <div className="container mx-auto jost-uniquifier">
        <h1 className="launch-header text-3xl sm:text-4xl lg:text-5xl font-semibold text-left mb-10 sm:mb-12 lg:mb-5 font-montserrat">
          Upcoming Events
        </h1>
        ...
        <div className="flex items-center text-cyan-600 px-2 text-base sm:text-lg mb-[16%] ">
              ...
              <span className="flex items-center lg:ml-[-6%] ml-[-10%] font-century-gothic">
                <img src={comments} className="w-[20%] h-[20%] lg:w-[25%] lg:h-[25%] mr-[3%]" />
                <h1 className="whitespace-nowrap text-xs md:text-sm">
                  0 comments
                </h1>
              </span>
              <h4 className="ml-auto text-black font-century-gothic">6 minute read</h4>
            </div>
