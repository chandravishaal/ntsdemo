...
const EachBlog = ({ title, date, description, imageUrl, author, profile, readTime}) => {
    return (
        <div className="each-blog flex flex-col items-start gap-8 rounded-2xl bg-gray-50 relative overflow-hidden"> {/* Set position relative to this container */}
            <div className="relative"> {/* Set position relative for child elements */}
                ...
                <span className="absolute top-2 right-2 text-primaryCyan text-md font-bold px-2 py-1 rounded">
                    cyptonews & Updates {/* Display the category here */}
                </span>
...
const CryptonewCatogery = () => {
    ...
    return (
        <section className="pb-10 pt-20 bg-white relative">
            <div className="container mx-auto px-4">
                <div className="each-blog text-left mb-20">
                    <h1 className="text-4xl font-bold">Crypto News & Updates</h1>
...
export default CryptonewCatogery;