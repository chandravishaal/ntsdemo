  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow-xl shadow-slate-950 rounded-2xl p-6 sm:p-8 lg:p-10 border-2 border-cyan-500 mx-auto max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl">
        ...
        <div className="mt-4">
          <h1 className="text-lg sm:text-xl lg:text-2xl text-center">Enter your personal details</h1>
        </div>

        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label className="block font-bold text-gray-700 text-sm sm:text-base">Enter your Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
              onChange={handleChange}
              placeholder="Name"
              className="w-full p-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 border-cyan-300 text-sm sm:text-base"
            />
          </div>

          <div>
            <label className="block font-bold text-gray-700 text-sm sm:text-base">Enter your Phone no</label>
            <input
              type="tel"
              name="phone"
              value={formData.phone}
          ...
          <div>
            <label className="font-bold block text-gray-700 text-sm sm:text-base">Enter your Email</label>
            <input
              type="email"
              name="email"
              value={formData.email}
              onChange={handleChange}
              placeholder="Email"
              className="w-full p-2 mt-2 mb-8 sm:mb-12 lg:mb-16 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 border-cyan-300 text-sm sm:text-base"
            />
          </div>
          ...
          <button
            type="submit"
            onClick={handleContinue}
            className="w-full py-2 text-white bg-cyan-500 rounded-lg hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 text-sm sm:text-base"
          >
            Continue
          </button>
        </form>
