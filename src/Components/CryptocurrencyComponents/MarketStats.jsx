      ...
      content: (
        <div className="flex flex-wrap justify-center p-4 md:p-10">
          <div className="w-full md:w-1/3 p-4">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">
              MARKET CAP
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">TYPICAL HOLD TIME
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">POPULARITY
              <span className='text-black font-light'>
                <InfoTooltip text="demo text" />
              </span>
            </span>
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">ALL TIME HIGH
              <span className='text-black font-light'>
                <InfoTooltip text="demo text" />
              </span>
            </span>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-wrap justify-center p-4 md:p-10">
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">PRICE CHANGE (2W)
              <span className='text-black  font-light'>
                <InfoTooltip text="demo text" />
              </span>
            </span>
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">PRICE CHANGE (1M)
              <span className='text-black  font-light'>
                <InfoTooltip text="demo text" />
              </span>
            </span>
          ...
          <div className="w-full md:w-1/3 p-7">
            <span className="text-2xl  font-century-gothic text-primaryCyan block text-center">PRICE CHANGE (1Y)
              <span className='text-black  font-light'>
                <InfoTooltip text="demo text" />
              </span>
            </span>
        ...
        {accordionData.map((item, index) => (
          <div key={index} className="border border-black">
            <button
              ...
              className={`w-full text-left px-4 py-4 bg-white flex justify-between items-center ${activeIndex === index ? 'bg-gray-100' : ''
                }`}
            >
              <span className="text-gray-800 font-medium">{item.title}</span>
              <i
                className={`ri-arrow-up-wide-fill text-gray-500 transform transition-transform ${activeIndex === index ? 'rotate-180' : ''
                  }`}
              ></i>
            </button>
            <div
              className={`overflow-hidden transition-max-height duration-500 ease-in-out ${activeIndex === index ? 'max-h-80' : 'max-h-0'}`}
            >
