...
const DesktopCompanySection = () => {
    ...
    return (
        <div className="relative h-[700px] px-5 transform scale-90">
            {/* blur effect */}
            <div className="absolute inset-0 flex justify-center items-center">
            ...
            <div className="min-h-[30rem] h-auto w-full flex items-center justify-center">
                <div className="w-full md:w-1/2 h-full px-5 md:h-[100%]  flex justify-center items-center">
                    ...
                    <div className="relative  scroll-py-36 px-5">
                        <h2 className="pt-14 text-3xl sm:text-3xl md:text-4xl font-antipasto-pro font-bold text-gray-800 flex items-center justify-center ">Join the Digital Revolution</h2>

                        <section className="flex flex-row items-center mt-12 justify-center relative z-10 min-h-[20rem] sm:min-h-[30rem]">
                            {/* 1sttt card*/}
...
export default DesktopCompanySection;