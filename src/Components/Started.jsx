    ...
    <section ref={sectionRef} className='bg-primaryCyan w-full py-10'>
      <div className="w-full container mx-auto flex lg:flex-row flex-col-reverse justify-between items-center lg:my-40 my-20">
        ...
        <div className='relative lg:pr-32 md:pr-0 pr-0 mt-10'>
          <div className='bg-white w-[250px] h-[250px] lg:w-[350px] lg:h-[350px] rounded-full flex items-center justify-center mb-24 lg:mb-0 shadow-2xl relative'>
            <img src="https://ntsmetrics.com/img/nsm-logo-blue.png" className='lg:w-3/6 w-[150px]' alt="" />
            <div className='absolute bg-white p-2 lg:w-[180px] lg:h-[180px] w-[130px] h-[130px] lg:-left-24 -left-20  rounded-full shadow-2xl flex flex-col items-center justify-center gap-3 animate-countup'>
              <img src={icon11} className='w-12 lg:w-16' alt="" />
              <p className="text-lg font-century-gothic font-bold text-primaryCyan">
                {isVisible && <CountUp end={10523684} duration={5} />}
              </p>
            ...
            <div className='absolute bg-white p-5 lg:w-[180px] lg:h-[180px] w-[130px] h-[130px] lg:-right-24 -right-20  rounded-full shadow-2xl flex flex-col items-center justify-center gap-3 animate-countup'>
              <img src={icon10} className='w-12 lg:w-16' alt="" />
              <p className="text-lg font-century-gothic font-bold text-primaryCyan">
                {isVisible && <CountUp end={73554} duration={5} />}
              </p>
          ...
          <h1 className='absolute text-white text-xl font-bold lg:-left-32 lg:top-72 md:top-56 md:-left-36 -left-16 top-52 md:whitespace-nowrap text-center'>
          ...
          <h1 className='absolute text-white text-xl font-bold lg:left-80 lg:top-72 md:top-56 md:left-56 -right-20 top-52 md:whitespace-nowrap text-center'>
