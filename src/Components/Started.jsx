    ...
    <section ref={sectionRef} className="w-full py-10">
      ...
      <div className="w-full container mx-auto flex lg:flex-row flex-col-reverse justify-between items-center lg:my-40 my-20">
        ...
        <div className="relative lg:pr-32 md:pr-0 pr-0 mt-10">
              ...
              <p className="text-3xl lg:text-4xl font-century-gothic font-bold text-black">
                {isVisible && (
                  <CountUp
                    ...
                    duration={5}
                    formattingFn={(value) => `${Math.floor(value / 1000000)}M+`}
                  />
                )}
              </p>
            </div>
              ...
              <p className="text-3xl lg:text-4xl font-century-gothic font-bold text-black">
                {isVisible && (
                  <CountUp
                    ...
                    duration={5}
                    formattingFn={(value) => `${Math.floor(value / 1000)}K+`}
                  />
                )}
              </p>
            </div>
          ...
          <img
            src={icon1}
            className="w-16 animate-bounce absolute lg:top-96 md:top-72 top-72 right-0"
            alt=""
          />
          <img
            src={icon2}
            className="w-16 md:top-10 animate-bounce md:-right-16 absolute -right-14 -top-10"
            alt="BNB"
          />
          <img
            src={icon3}
            className="w-16 lg:left-0 left-0 md:top-72 top-72 lg:top-96 animate-bounce absolute right-0"
            alt="etherium"
          />
          <img
            src={icon4}
            className="w-12 animate-bounce top-0 -left-10 absolute right-0"
            alt="matic"
          />
        </div>
      </div>
