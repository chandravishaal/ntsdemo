...
//             />
//             <div className='lg:pl-12 p-2 w-[70%] lg:-ml-5 relative z-10 md:mt-[15%] mx-auto md:text-left text-center -translate-x-[1rem] border border-black'>
...
//           <div className="feature-item flex flex-col-reverse md:flex-row items-center justify-end text-center md:text-right lg:items-end md:p-8 relative w-full border border">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
          ...
          <div className="feature-item flex flex-col md:flex-row items-center md:items-start justify-center relative w-full pt-10 md:p-8">
            ...
            />
            <div className=' lg:px-12 p-2 w-[70%] relative z-10 md:mt-[15%] mx-auto text-center'>
              <h2 className="text-2xl font-bold text-black mb-2 font-montserrat">North Star Metrics</h2>
          ...
          <div className="feature-item flex flex-col-reverse md:flex-row items-center md:items-end justify-center relative w-full md:p-8">
            <div className=' w-[70%] lg:px-12 p-2 relative z-10 mb-[25%] mx-auto text-center'>
              <h2 className="text-2xl font-bold text-black mb-2 font-montserrat">Advance</h2>
