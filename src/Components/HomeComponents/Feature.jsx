      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 ">
          ...
          <div className="flex flex-col md:flex-row items-start lg:items-start relative w-full">
            <img data-aos="fade-left" data-aos-duration="2000" src={mobileImage1} alt="Feature showcasing North Star Metrics for buying and selling cryptocurrencies" className="w-auto h-[565px]  mx-auto md:-translate-x-[2rem] mr-10" />
          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-end text-center lg:text-right lg:items-end  relative w-full">
            <div data-aos="fade-down" data-aos-duration="2000" className='w-[70%] pr-10  lg:-mr-10 relative z-10 mb-[25%] translate-x-[1rem] md:text-right text-center'>
              ...
              <SecondaryButton title="Sell" className="mr-10"/>
              <PrimaryButton title="Buy" className="mr-10"/>
              </div>
            </div>
