...
const WhyUs = () => {
  ...
  return (
    <div className="why-us-section container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row items-center justify-between">
        {/* Phone Image Section */}
        <div className="phone-image w-full md:w-1/2 h-auto md:h-[650px]  md:ml-[-10%]">
          <img
            src={phone}
            className="w-[120%] h-auto max-w-[500px] md:max-w-none"
          />
        ...
        {/* Text Section */}
        <div className="w-full md:w-1/2 mt-8 md:mt-0">
          <h2 className="text-5xl font-semibold jost-uniquifier mb-12 font-montserrat">Why Us</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="feature flex items-start space-x-4">
              ...
              />
              <div>
                <h3 className="text-xl font-semibold jost-uniquifier mb-2 font-century-gothic">Cutting-Edge Security</h3>
