    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-between container mx-auto px-[4%] py-[6%] space-y-8 lg:space-y-[-3%] lg:space-x-[2%]">
        ...
        <div className={"left-section w-full lg:w-1/2 text-left px-[-2%] lg:ml-[-2%]"}>
          ...
          <p className={"left-section-text text-lg lg:text-2xl xl:text-2xl jost-uniquifier text-black mb-[9%] font-century-gothic"}>
            Are you looking for an OTC (Over the Counter) Cryptocurrency Exchange Desk that can offer you several cryptocurrencies within seconds?
          </p>

          {/* Button Section */}
          <div className="flex justify-center lg:justify-start w-full">
            <button className="left-section-button bg-cyan-500 jost-uniquifier text-black px-[6%] py-[3%] rounded-lg font-medium text-lg font-century-gothic">
              Get Started Now
            </button>
          </div>
        </div>
